  ...
  return (
    <div className="relative min-h-screen flex justify-center py-10 px-4 text-[#0c3d7c]">
      ...
      <div className="absolute inset-0 -z-10">
        <Image src="/bg-watermark.webp" alt="Caminão de fundo" fill priority className="object-cover" />
      </div>
      ...
      <div className="flex flex-col items-center lg:items-start lg:flex-row lg:justify-center gap-8 w-full px-4">
        <div className="bg-white w-full max-w-md lg:max-w-[345px] rounded-3xl shadow-lg pb-1 pt-4 px-7">
          ...
          <div className="flex flex-col gap-1 mt-3 border-b border-gray-200 pb-5">
            ...
            <a href="https://wa.me/5511977120119" className=" underline underline-offset-4 text-sm font-medium">
              CLIQUE E FALE COM NOSSOS ATENDENTES
            </a>
          </div>
          ...
          <div className="flex justify-center m-3">
            <Image src="/logo-novo.webp" alt="Logo Global Cargo" height={90} width={350} className="h-10 w-auto" />
          </div>
        </div>
