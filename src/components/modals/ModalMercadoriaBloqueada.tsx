    ...
    <AnimatePresence>
      {info && (
        <div {...props} className={`fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 lg:p-0`}>
          <motion.div
            className="flex flex-col gap-4 w-full max-w-md lg:max-w-xl bg-white rounded-2xl py-8 pb-6 px-6"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            ...
            <>
              <div className="flex flex-col items-center gap-1">
                ...
                {info === "naturezaBloqueada" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Esta modalidade de mercadoria não pode ser solicitada via site.
                    </span>
                  </>
                )}
                ...
                {info === "valorElevado" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Notamos que o valor da sua Nota Fiscal é maior que R$ 250.000,00
                    </span>
                  </>
                )}
                ...
                {info === "valorBaixo" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Notamos que o valor da sua Nota Fiscal é menor que R$ 200,00
                    </span>
                  </>
                )}
                ...
                {info === "pesoElevado" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Notamos que o peso total da sua carga ultrapassa 500 KG
                    </span>
                  </>
                )}
                ...
                {info === "medidasElevadas" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Nenhuma medida (comprimento, largura ou altura) pode exceder 2,00 metros.
                    </span>
                  </>
                )}
                ...
                {info === "erroConsulta" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      Ocorreu um erro durante a consulta. Tente novamente mais tarde.
                    </span>
                  </>
                )}
                ...
                {info === "cadastroInexistente" && (
                  <>
                    ...
                    <span className="text-center text-gray-400">
                      O documento informado não está registrado em nosso sistema.
                    </span>
                  </>
                )}
              </div>
              ...
              <div className="flex flex-col items-center bg-orange-50 rounded-md border border-orange-200 px-6 py-4 gap-5">
                {/* {info === "natureza" && (<>
                            ...
                            {info === "cadastroInexistente" && (<>
                                <span className="text-orange-700 text-md">Ligue agora e continue a solicitação de sua coleta</span>
                            </>)} */}
                ...
                <span className="text-orange-700 text-sm italic font-medium">
