...
export default function FormSolicitante({ solicitanteVerificado }: FormSolicitanteProps) {

    //useFormContext para importar o useForm do formulário principal "integrando" eles
    const { control, trigger, clearErrors, formState: { errors } } = useFormContext<CotacaoDados>()
    ...
    return (
        <motion.div className="flex flex-col px-1 gap-2 overflow-hidden"
            animate={{ height: "auto" }}
        ...
        >
            ...
            <div>
                ...
                <p className="text-gray-500 text-md font-light">Informações de quem está solicitando a cotação</p>
            </div>
            ...
            <div className="flex flex-col gap-2 lg:flex-row lg:justify-between w-full">
                ...
                <div className="lg:w-[43%] flex flex-col">
                    ...
                    <Label obrigatorio={true} htmlFor="solicitanteDoc">Documento do solicitante</Label>
                    <Controller
                        name="solicitanteDoc"
                        control={control}
                        render={({ field }) => (
                ...
                <div className="lg:w-[43%] flex flex-col">
                    ...
                    <Label obrigatorio={true} htmlFor="solicitanteNome">Nome do solicitante</Label>
                    <Controller
            ...
            <div className="flex flex-rol justify-end">
                <button className="flex flex-row gap-2 rounded-2xl bg-blue-500 py-2 px-3 text-white cursor-pointer hover:-translate-y-0.5
                        transition-all active:scale-95" onClick={validarCampos} type="button">Avançar</button>
            </div>
        </motion.div>
    )
}