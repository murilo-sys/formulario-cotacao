...
export default function FormParticipantes() {
    ...
    const classNameBase =
        "p-1 active:scale-95 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer w-full flex justify-center border border-blue-400 rounded-md ";
            ...
            <div>
                <div>
                    ...
                    <p className="text-gray-500 text-md font-light">
                        Informações dos participantes da cotação
                    </p>
                </div>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <div className="flex flex-row gap-3 w-full">
                            {/*input remetente*/}
                            <label
                                className={`${classNameBase} ${field.value === "rem" ? "bg-blue-800 text-white" : "bg-blue-300 text-black"}`}
                            >
                                <input
                                    type="radio"
                                    name={field.name}
                                    value="rem"
                                    checked={field.value === "rem"}
                                    onChange={() => field.onChange("rem")}
                            ...
                            {/*Input destinatario*/}
                            <label
                                className={`${classNameBase} ${field.value === "dest" ? "bg-blue-800 text-white" : "bg-blue-300 text-black"}`}
                            >
                                <input
                                    type="radio"
                                    name={field.name}
                                    value="dest"
                                    checked={field.value === "dest"}
                                    onChange={() => field.onChange("dest")}
                                    className="appearance-none"
                                />
