        ...
        >
          <div className="flex flex-col border-b pb-3 border-blue-500 border-dotted lg:border-none lg:grid lg:grid-cols-4 lg:grid-rows-1 gap-3">
            <div className="flex flex-col">
              <Label htmlFor={`quantidade${index}`} className="font-light" obrigatorio={true}>
                Volumes
              </Label>
              <Controller
            ...
            <div className="flex flex-col">
              <Label htmlFor={`comprimento${index}`} className="font-light" obrigatorio={true}>
                Comprimento
              </Label>
              <Controller
            ...
            <div className="flex flex-col">
              <Label htmlFor={`largura${index}`} className="font-light" obrigatorio={true}>
                Largura
              </Label>
              <Controller
            ...
            <div className="flex flex-col">
              <Label htmlFor={`altura${index}`} className="font-light" obrigatorio={true}>
                Altura
              </Label>
              <Controller
